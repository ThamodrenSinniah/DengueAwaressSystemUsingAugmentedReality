...
public class AugmentedMosquito extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_augmented_mosquito);
        ...
        arFragment.setOnTapArPlaneListener((hitResult, plane, motionEvent) -> {
            ...
            ModelRenderable.builder()
                    .setSource(this, Uri.parse("MOSQUITO_3DMODEL.sfb"))
                    .build()
